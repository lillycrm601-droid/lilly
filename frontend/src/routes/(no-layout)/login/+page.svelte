...
<svelte:head>
  <title>Sign in | LillyCRM</title>
  <meta
    name="description"
    content="Sign in or sign up for LillyCRM to manage your contacts, deals, and grow your business."
  />
</svelte:head>
...
<div class="login-page">
  ...
  <div class="login-wrapper">
    ...
    <footer class="login-footer">
      <a href="https://lillycrm.io/privacy-policy">Privacy Policy</a>
      <span class="dot"></span>
      <a href="https://lillycrm.io/terms">Terms of Service</a>
      <span class="dot"></span>
