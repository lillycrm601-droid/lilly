...
This guide explains how to set up PostgreSQL with Row-Level Security for LillyCRM multi-tenancy.
...
```sql
-- Connect to lillycrm database
\c lillycrm

-- Grant connection rights
GRANT CONNECT ON DATABASE lillycrm TO crm_user;
